  ...
  networks: {
    ...
    rinkeby: {
      provider: function() {
        ...
        return new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/v3/323e44018f994f0c97025d409eb79344`, 0, 10)
      },
      network_id: 4,
    ...
    ropsten:{
      provider: function() {
        ...
        const mnemonic = 'filter else barely slide fat total umbrella actual differ kind sure midnight'
        // if (!process.env.INFURA_API_KEY) {
        //   throw new Error("INFURA_API_KEY env var not set")
        // }
        return new HDWalletProvider(mnemonic, `https://ropsten.infura.io/v3/323e44018f994f0c97025d409eb79344`, 0, 10)
      },
      network_id: 3,
      gasPrice: 15000000001,
      skipDryRun: true
